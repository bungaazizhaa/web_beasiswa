    ...
    <div class="container">
        <div class="text-center">
            ...
            <div class="alert alert-success mt-4 teksalert" role="alert">
                <strong>SELAMAT ! ANDA LOLOS TAHAP WAWANCARA <br>
                    BEASISWA SARIRAYA JAPAN {{ strtoupper($getPeriodeAktif->name) }}</strong>
            </div>

            <p>Soal untuk Tahap Penugasan Anda :</p>
            <p class="font-weight-bold">{{ $getAdministrasiUser->wawancara->penugasan->soal }}</p>
            <p>Formulir pengisian akan muncul ketika Tahap Penugasan telah
                dimulai ({{ $getPeriodeAktif->tm_png->translatedFormat('l, d F Y') }}). </p>
            @auth
